...
The DLL code is based on https://github.com/TheIndra55/TRAE-menu-hook (pruned all code not needed for drm loading and added changes to read .drm from local "mods" subdirectory.
